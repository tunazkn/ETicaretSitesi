<%@ Page Title="Anasayfa" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="ETicaretSitesi.Home" %>
                ...
                <div class="row shadow px-1" style="border: 1px solid black; float: left; word-break: break-all;">
                        ...
                        <div class="ml-auto">
                            <div class="container">
                                <div class="p-1 ml-auto" style="float: right;">
                                    <asp:LinkButton CssClass="page-link shadow" ID="LinkbtnYuksekPuanli" runat="server" Text="Tümünü Göster >>" Font-Bold="true" OnClick="LinkbtnYuksekPuanli_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row navbar-expand-md shadow m-2">
                        <asp:DataList CssClass="shadow" RepeatDirection="Horizontal" RepeatColumns="5" ID="DataListYuksekPuanli" runat="server">
                            <ItemTemplate>
                                <!-- buton üste çıkmayı buraya ekleyeceğiz.-->
                                <div class="card m-3 shadow" style="width: 190px; height: 320px; text-align: center; align-content: center; word-break: break-word;">
                                    ...
                                    <div class="card-body" style="word-break: break-word;">
                                        <div class="collapse navbar-collapse bg-transparent" id="anaMenu">
                                            <table class="form-signin">
                                                <tr>
                                                    <td><a class="bk" href="KitapDetay.aspx?Kitapid=<%# Eval("Kitapid") %>" title='<%# Eval("KitapAdi") %>'>
                                    ...
                                    <table class="form-signin my-1">
                                        <tr>
                                            <td>
                                                <div>
                                                    <a class="btn btn-outline-info p-1 mr-1" href="KitapDetay.aspx?Kitapid=<%# Eval("Kitapid") %>" title="Detaylar">Detaylar</a><a class="btn btn-outline-success p-1 ml-1" href="KitapDetay.aspx?Kitapid=<%# Eval("Kitapid") %>" title="hghg">Detaylar</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <div class="row shadow px-1" style="border: 1px solid black; float: left; word-break: break-all;">
                    <div class="container bg-light">
                        ...
                        <div class="ml-auto">
                            <div class="container">
                                <div class="p-1 ml-auto" style="float: right;">
                                    <asp:LinkButton CssClass="page-link shadow" ID="LinkbtnDusukPuanli" runat="server" Text="Tümünü Göster >>" Font-Bold="true" OnClick="LinkbtnDusukPuanli_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
