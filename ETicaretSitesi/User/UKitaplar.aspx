<%@ Page Title="Kitaplar | Kullanıcı" Language="C#" MasterPageFile="~/User/Kullanici.Master" AutoEventWireup="true" CodeBehind="UKitaplar.aspx.cs" Inherits="ETicaretSitesi.User.UKitaplar" %>
                ...
                <div class="navbar navbar-expand-md navbar-dark mx-1 bg-light">
                    <div class="row shadow px-1" style="border: 1px solid black; float: left; word-break: break-all;">
                        ...
                        <div class="row navbar-expand-md shadow m-2">
                            <asp:DataList CssClass="shadow" RepeatDirection="Horizontal" RepeatColumns="4" ID="DataListTumKitaplar" runat="server">
                                <ItemTemplate>
