<%@ Page Title="İşlemi Onayla" Language="C#" MasterPageFile="~/User/Kullanici.Master" AutoEventWireup="true" CodeBehind="UKitapSatinal.aspx.cs" Inherits="ETicaretSitesi.User.UKitapSatinal" %>
                            ...
                            <ItemTemplate>
                                <div class="row m-2" style="text-align: center; align-content: center; word-break: break-word;">
                                    <table class="form-signin">
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label8" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="XX-Large" Text="'"></asp:Label>
                                                <asp:Label ID="Labelkitapadi" runat="server" Text='<%# Eval("KitapAdi") %>' Font-Bold="true" ForeColor="Red" Font-Size="XX-Large"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Labelanasayfa" runat="server" Font-Bold="true" ForeColor="Red" Font-Size="XX-Large" Text=" ' isimli bu kitabı almayı onaylıyor musun?"></asp:Label>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
...
<asp:DataList CssClass="shadow" RepeatDirection="Horizontal" RepeatColumns="4" ID="DataListKitapDetayonay" runat="server"><ItemTemplate>
<div class="card bg-light shadow m-1" style="min-height: 400px; width: 535px; word-break: break-word;"><table class="form-signin ml-2 bg-transparent"><tr>
<td style="word-break: break-word;">
<asp:Label ID="lblTumKitapAdi" runat="server" Font-Bold="true" Font-Size="30" Text='<%# Eval("KitapAdi") %>'></asp:Label></a></td></tr><tr>
...
<asp:Label ID="lblTumYazarAdi" runat="server" Font-Bold="true" Font-Size="15" Text='<%# Eval("YazarAdiSoyadi") %>'></asp:Label></a></td></tr><tr>
<td style="word-break: break-all; height: 35px;">
...
<asp:Label ID="lblTumYayineviAdi" runat="server" Font-Bold="true" Font-Size="15" Text='<%# Eval("YayineviAdi") %>'></asp:Label></a></td></tr><tr>
<td style="word-break: break-all; height: 35px;"><table><tr style="text-align: right;"><td>
...
<asp:Label ID="Label4" runat="server" Text="/ 5 "></asp:Label></td></tr></table></td></tr>
<tr class="ml-4"><td style="word-break: break-all;"><table><tr>
<td style="text-align: "><table><tr><td>
<asp:Label ID="Label6" CssClass="ml-auto" runat="server" ForeColor="Transparent" Text="..."></asp:Label></td></tr><tr><td><asp:Label ID="Label3" CssClass="ml-auto" runat="server" Font-Size="10" Text=" 1 Adet "></asp:Label>
</td>
</tr>
</table>
</td>
